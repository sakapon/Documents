...
と、まるで定型のように項目が並んでいるのを見かけると思いますが、これのことです。  
...
しかし結論から言ってしまうと、実際に書籍を調べたところ、それらの記事の内容は書籍に書かれていませんでした。  
...
### 調査結果
結論として、「ネクスト・ソサエティ」「ドラッカー5つの質問」においてそれらしい用語が登場するものの、これらを MVV の出典と考えるのは無理があると考えています。
